...
| P11 | **Implémentez le front-end d'une application bancaire avec React** | [oc-argentbank](https://github.com/boysers/oc-argentbank) | `react` `typescript` `redux` `swagger` | 🟨 |
